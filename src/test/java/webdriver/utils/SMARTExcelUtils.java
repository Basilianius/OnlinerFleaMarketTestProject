 ...
 */
public class SMARTExcelUtils extends BaseEntity {
     ...
     */
    public SMARTExcelUtils(FileFormat fileFormat) {
     ...
     */
    public SMARTExcelUtils(String fileName) {
        try {
    ...
    private boolean isFileInOldFormat(String fileName) {
        ...
        return str[str.length - 1].equals("xls") ? true : false;
    }
    ...
    private int getColIndexByName(String colName) {
        ...
        int cellNameLengthCount = colName.length() - 1;
        int resultIdx = 0;
        for (char currChar : colName.toCharArray()) {
